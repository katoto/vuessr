<template>
    <section class="l-flex-1 l-relative" v-if="awayData">
        <div class="inte-main l-full l-scroll-y" >
            <div class="games-list game-list-b " v-if="awayData['rettype'] === 'array' ">
                <table class="games" width="100%" cellspacing="0" cellpadding="0">
                    ...
                    <tr  v-for="item in awayData.values" v-tap="{methods:goTeam,teamid:item.teamid}">
                        <td>
        ...
        <view-empty v-if="!awayData || !awayData.length"></view-empty>
    </section>
</template>
