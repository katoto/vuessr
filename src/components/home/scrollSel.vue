<template>
    <div class="item-tab">
        <ul>
            ...
            <li data-p4="zucai" :class="{'cur': ~$route.path.indexOf('/sfc')}" v-tap="{methods: switchTab, path: '/home/zq/sfc/cur'}"><router-link to="/home/zq/sfc/cur" replace>足球</router-link></li>
