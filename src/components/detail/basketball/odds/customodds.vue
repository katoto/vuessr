                    ...
                    <div class="my-companys" v-if="customMy  && customOdds">
                        <ul class="company-items">
                            <li class="company-item" v-for="(item,idx) in customOdds.company.custom">
                                <span class="com-name">
                                    <em  v-tap="{methods:deleteCustomOdd, idx}"></em>{{item.name}}
                                </span>
                                <span
                                        class="com-zd" :class="{'had-zd':idx==0}" v-tap="{methods:setCustomTop,idx}">置顶</span>
                            </li>
                        </ul>
                        ...
                        <div class="ques-item" v-for="key in  customKeyList">
                            ...
                            <ul class="company-items">
                                <li class="company-item" v-for="(odd,index) in customOdds.company.all[key]">
                                    <span class="com-name">{{odd.name}}
                                        <i class="zlgs" v-if="odd.type=='1'">主</i>
                                        <i v-if="odd.type=='3'" class="jys">E</i>
                                    </span>
                                    <span v-tap="{methods:addCustomOdd,key,idx:index}" :class="{'had-zd':odd.ischeck=='1'}" class="com-zd">
                                        {{odd.ischeck=='1'?'已添加':'添加'}}
                                    </span>
                                </li>
                            </ul>
                        </div>
