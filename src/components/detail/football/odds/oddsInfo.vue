        ...
        <div class="popInner">
           ...
           <!-- <div class="plright" drunk-init-data="oddsVisibleType = 'europe'"
                ...
                <ul class="popTab clear">
                    <li drunk-class="{cur: oddsVisibleType == 'europe'}" drunk-on="click: oddsVisibleType = 'europe'">
                        赔率变化
                    </li>
                    <li drunk-class="{cur: oddsVisibleType == 'sameEurope'}"
                        drunk-on="click:oddsVisibleType = 'sameEurope'">历史同赔
                    </li>
                </ul>
                <div class="pl-cont" drunk-if="oddsVisibleType == 'europe'"
                        ...
                        <div class="plcontent">
                            <table cellpadding="0" cellspacing="0" border="0" width="100%" class="plxq-table"
                                ...
                                <tr drunk-repeat="info,index in oddsInfo">
                                    <td><span class="f24"
                                              drunk-class="{'red': info.win_change == 1, 'green': info.win_change == -1}">{{parseFloat(info.win).toFixed(2)}}</span>
                                    </td>
                                    <td><span class="f24"
                                              drunk-class="{'red': info.draw_change == 1, 'green': info.draw_change == -1}">{{parseFloat(info.draw).toFixed(2)}}</span>
                                    </td>
                                    <td><span class="f24"
                                              drunk-class="{'red': info.lost_change == 1, 'green': info.lost_change == -1}">{{parseFloat(info.lost).toFixed(2)}}</span>
                                    </td>
                ...
                <div class="pl-cont" drunk-if="oddsVisibleType == 'sameEurope'"
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%"
                                ...
                                <tr drunk-init-data="isSameEuropeAllMore=false"
                                    ...
                                    <td class=" result-last"
                                        drunk-class="{'result-win':match.result=='胜','result-level':match.result=='平','result-lose':match.result=='负'}">
