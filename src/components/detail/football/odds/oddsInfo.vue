            ...
            <div class="l-full l-flex-row">
                ...
                <div class="l-flex-1 l-flex-column" style="width:0;border-radius: 0 .186667rem 0 0"
                    ...
                    <ul class="popTab clear">
                        <li :class="{cur: tab === 0}" v-tap="{methods: changeTab, tab: 0}">
                            赔率变化
                        </li>
                        <li :class="{cur: tab === 1}"
                            v-tap="{methods: changeTab, tab: 1}">历史同赔
                        </li>
                    </ul>
                    <div class="l-flex-1 l-relative">
                        <div class="l-full l-scroll-y" style="overflow: auto;" v-if="tab === 0 && oddsInfo && oddsInfo.length">
                            <div class="plcontent">
                        ...
                        <div class="l-full l-scroll-y" style="overflow: auto;"
                             v-if="tab === 1 && sameOddsInfo && sameOddsInfo.all_count">
                            <div class="plcontent">
