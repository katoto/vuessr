...
<div class="l-full l-flex-column">
    <div class="detailTop " style="display: block;"><a onclick="history.back()" href="javascript:;" class="back-icon">返回</a><a href="/score/index.html#/basketball" class="link-index f26">比分首页</a>
